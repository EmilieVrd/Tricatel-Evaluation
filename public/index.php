...
//pour qu'en prod la stacktrace d'une error ne s'affiche pas
//error_reporting(0);
...
$router
    ->get('/', 'post/index', 'home')
    ->get('/catalogue/category/[*:slug]-[i:id]', 'category/show', 'category')
    ->get('/catalogue/[*:slug]-[i:id]', '/post/show', 'post')
